...
We have provided some containers to help build your application in Pyhton with a variety of persistence layers available to use. (you may start from scratch if you like)

### Technology

- Valid Pyhton 3.8 or newer
...
- You **MUST** write testable code and demonstrate unit testing it (for clarity, We encourage you to use unittest or any other kind of **testing** framework).
...
- Following the industry standard style guide for the language you choose to use - `PEP8` etc.
